...
namespace MyGame
{
    static class Input
    {
        ...
        private static bool isAimingWithMouse = false; //checks if we are using mouse or gamepad controls/arrow keys
        ...
        public static void Update()
        {
            ...
            else if (MousePosition != new Vector2(lastMouseState.X, lastMouseState.Y)) // if the player moves the mouse, enable mouse aiming.
        ...
        {
            Vector2 direction = MousePosition - MainTower.Instance.Position;
